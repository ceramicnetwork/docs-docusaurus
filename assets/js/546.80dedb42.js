...
function validateValue(type, valueAST) {
  ...
  if (type instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLNonNull */ .bM) {
  ...
  if (type instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLList */ .p2) {
  ...
  if (type instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLInputObjectType */ .sR) {
    ...
    for (const fieldName of Object.keys(type.getFields())) {
      ...
      if (!providedFields[fieldName] && field.type instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLNonNull */ .bM && !field.defaultValue) {
        fieldErrors.push([
          valueAST,
  ...
  if ((type instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLEnumType */ .mR || type instanceof graphql__WEBPACK_IMPORTED_MODULE_5__/* .GraphQLScalarType */ .n2) && (valueAST.kind !== "String" && valueAST.kind !== "Number" && valueAST.kind !== "Boolean" && valueAST.kind !== "Null" || isNullish(type.parseValue(valueAST.value)))) {
    return [[valueAST, `Expected value of type "${type}".`]];
  }
  return [];
}
