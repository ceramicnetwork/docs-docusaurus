...
//# sourceMappingURL=Range.es.js.map
...
/* harmony export */   c: () => (/* binding */ codemirror)
/* harmony export */ });
/* harmony import */ var _index_es_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(32689);
var __defProp = Object.defineProperty;
var __name = (target, value) => __defProp(target, "name", { value, configurable: true });
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(58252);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(72788);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(76701);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(19798);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(5265);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(38867);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(70312);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(60495);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(80441);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(47803);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(66623);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(52509);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(19224);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(52503);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(12238);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(39601);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(86654);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(33234);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(11505);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(25677);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(57390);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(36906);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(36756);
/* harmony import */ var _index_es_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(32689);
/* harmony import */ var _Range_es_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(83216);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(59496);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4637);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(87995);
var __defProp = Object.defineProperty;
var __name = (target, value) => __defProp(target, "name", { value, configurable: true });
...
function validateWithCustomRules(schema, ast, customRules, isRelayCompatMode, isSchemaDocument) {
  const rules = graphql__WEBPACK_IMPORTED_MODULE_18__/* .specifiedRules */ .i.filter((rule) => {
  ...
  return errors.filter((error) => {
    if (error.message.includes("Unknown directive") && error.nodes) {
      ...
      if (node && node.kind === graphql__WEBPACK_IMPORTED_MODULE_23__/* .Kind */ .h.DIRECTIVE) {
...
function getDiagnostics(query, schema = null, customRules, isRelayCompatMode, externalFragments) {
  ...
  if (externalFragments) {
    fragments = typeof externalFragments === "string" ? externalFragments : externalFragments.reduce((acc, node) => acc + (0,graphql__WEBPACK_IMPORTED_MODULE_24__/* .print */ .S)(node) + "\n\n", "");
  }
  const enhancedQuery = fragments ? `${query}

${fragments}` : query;
  try {
    ast = (0,graphql__WEBPACK_IMPORTED_MODULE_25__/* .parse */ .Qc)(enhancedQuery);
  } catch (error) {
    if (error instanceof graphql__WEBPACK_IMPORTED_MODULE_26__/* .GraphQLError */ .__) {
...
function validateQuery(ast, schema = null, customRules, isRelayCompatMode) {
  ...
  const deprecationWarningAnnotations = (0,graphql__WEBPACK_IMPORTED_MODULE_22__/* .validate */ .Gu)(schema, ast, [
    graphql__WEBPACK_IMPORTED_MODULE_27__/* .NoDeprecatedCustomRule */ .r
...
function getRange(location, queryText) {
  ...
  for (let i = 0; i < location.line; i++) {
    stream = new _index_es_js__WEBPACK_IMPORTED_MODULE_1__.C(lines[i]);
    while (!stream.eol()) {
