...
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(86395);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(21919);
/* harmony import */ var _forEachState_es_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(19151);
...
c(N, "lexicalDistance");
_codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.registerHelper("hint", "graphql-variables", (i, n) => {
  const t = i.getCursor(), r = i.getTokenAt(t), e = D(t, r, n);
  return e != null && e.list && e.list.length > 0 && (e.from = _codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.Pos(e.from.line, e.from.ch), e.to = _codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.Pos(e.to.line, e.to.ch), _codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.signal(i, "hasCompletion", i, e, r)), e;
});
function D(i, n, t) {
  ...
  if (e === "StringValue" || e === "NumberValue" || e === "BooleanValue" || e === "NullValue" || e === "ListValue" && l === 1 || e === "ObjectField" && l === 2 || e === "Variable" && l === 2) {
    const a = p.type ? (0,graphql__WEBPACK_IMPORTED_MODULE_3__/* .getNamedType */ .xC)(p.type) : void 0;
    if (a instanceof graphql__WEBPACK_IMPORTED_MODULE_3__/* .GraphQLInputObjectType */ .sR)
      return f(i, n, [{ text: "{" }]);
    if (a instanceof graphql__WEBPACK_IMPORTED_MODULE_3__/* .GraphQLEnumType */ .mR) {
      const o = a.getValues();
    ...
    if (a === graphql__WEBPACK_IMPORTED_MODULE_4__/* .GraphQLBoolean */ .EZ)
      return f(i, n, [
        { text: "true", type: graphql__WEBPACK_IMPORTED_MODULE_4__/* .GraphQLBoolean */ .EZ, description: "Not false." },
        { text: "false", type: graphql__WEBPACK_IMPORTED_MODULE_4__/* .GraphQLBoolean */ .EZ, description: "Not true." }
      ]);
  }
}
...
function M(i, n) {
  ...
  return (0,_forEachState_es_js__WEBPACK_IMPORTED_MODULE_1__.f)(n, (r) => {
    switch (r.kind) {
      case "Variable": {
        t.type = i[r.name];
        break;
      ...
      case "ListValue": {
        const e = t.type ? (0,graphql__WEBPACK_IMPORTED_MODULE_3__/* .getNullableType */ .tf)(t.type) : void 0;
        t.type = e instanceof graphql__WEBPACK_IMPORTED_MODULE_3__/* .GraphQLList */ .p2 ? e.ofType : null;
        break;
      }
      case "ObjectValue": {
        const e = t.type ? (0,graphql__WEBPACK_IMPORTED_MODULE_3__/* .getNamedType */ .xC)(t.type) : void 0;
        t.fields = e instanceof graphql__WEBPACK_IMPORTED_MODULE_3__/* .GraphQLInputObjectType */ .sR ? e.getFields() : null;
        break;
      }
      case "ObjectField": {
