...
var I = (O, E) => w(O, "name", { value: E, configurable: !0 });
...
(function(O, E) {
  (function(u) {
    u((0,_codemirror_es2_js__WEBPACK_IMPORTED_MODULE_0__.r)());
  })(function(u) {
      ...
      e: {
        ...
        if (e.operation(function() {
          for (var b = a; b <= m; ++b) {
            ...
            p < 0 || (x.slice(L, L + g.length) == g && (L += g.length), d = !0, e.replaceRange("", r(b, p), r(b, L)));
          }
        }), d)
          return !0;
      }
...
`).indexOf(S) > -1)
      ...
      return R = T == -1 || q == -1 ? -1 : l.ch + q, T != -1 && R != -1 && R != l.ch ? !1 : (e.operation(function() {
        e.replaceRange(
          "",
...
var z = K.exports;
const Q = /* @__PURE__ */ (0,_codemirror_es2_js__WEBPACK_IMPORTED_MODULE_0__.g)(z), X = /* @__PURE__ */ J({
  __proto__: null,
  default: Q
}, [z]);
