...
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(86395);
/* harmony import */ var graphql__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(21919);
/* harmony import */ var _forEachState_es_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(44703);
/* harmony import */ var _index_es_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(32689);
...
function getVariablesHint(cur, token, options) {
  ...
  if (kind === "StringValue" || kind === "NumberValue" || kind === "BooleanValue" || kind === "NullValue" || kind === "ListValue" && step === 1 || kind === "ObjectField" && step === 2 || kind === "Variable" && step === 2) {
    const namedInputType = typeInfo.type ? (0,graphql__WEBPACK_IMPORTED_MODULE_6__/* .getNamedType */ .xC)(typeInfo.type) : void 0;
    if (namedInputType instanceof graphql__WEBPACK_IMPORTED_MODULE_6__/* .GraphQLInputObjectType */ .sR) {
      return hintList(cur, token, [{ text: "{" }]);
    }
    if (namedInputType instanceof graphql__WEBPACK_IMPORTED_MODULE_6__/* .GraphQLEnumType */ .mR) {
    ...
    if (namedInputType === graphql__WEBPACK_IMPORTED_MODULE_7__/* .GraphQLBoolean */ .EZ) {
      return hintList(cur, token, [
        { text: "true", type: graphql__WEBPACK_IMPORTED_MODULE_7__/* .GraphQLBoolean */ .EZ, description: "Not false." },
        { text: "false", type: graphql__WEBPACK_IMPORTED_MODULE_7__/* .GraphQLBoolean */ .EZ, description: "Not true." }
      ]);
    }
  }
}
...
function getTypeInfo(variableToType, tokenState) {
  ...
  (0,_forEachState_es_js__WEBPACK_IMPORTED_MODULE_1__.f)(tokenState, (state) => {
    switch (state.kind) {
      ...
      case "ListValue": {
        const nullableType = info.type ? (0,graphql__WEBPACK_IMPORTED_MODULE_6__/* .getNullableType */ .tf)(info.type) : void 0;
        info.type = nullableType instanceof graphql__WEBPACK_IMPORTED_MODULE_6__/* .GraphQLList */ .p2 ? nullableType.ofType : null;
        break;
      }
      case "ObjectValue": {
        const objectType = info.type ? (0,graphql__WEBPACK_IMPORTED_MODULE_6__/* .getNamedType */ .xC)(info.type) : void 0;
        info.fields = objectType instanceof graphql__WEBPACK_IMPORTED_MODULE_6__/* .GraphQLInputObjectType */ .sR ? objectType.getFields() : null;
        break;
      }
      case "ObjectField": {
