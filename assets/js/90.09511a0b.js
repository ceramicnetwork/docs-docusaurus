...
/* harmony import */ var _show_hint_es_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(23290);
/* harmony import */ var graphql_language_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(78705);
/* harmony import */ var _codemirror_es2_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(74291);




_codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.registerHelper("hint", "graphql", (o, a) => {
  const { schema: i, externalFragments: c } = a;
  if (!i)
    return;
  const s = o.getCursor(), e = o.getTokenAt(s), l = e.type !== null && /"|\w/.test(e.string[0]) ? e.start : e.end, p = new graphql_language_service__WEBPACK_IMPORTED_MODULE_2__/* .Position */ .Ly(s.line, l), t = {
    list: (0,graphql_language_service__WEBPACK_IMPORTED_MODULE_2__/* .getAutocompleteSuggestions */ .$1)(i, o.getValue(), p, e, c).map((n) => ({
      text: n.label,
      type: n.type,
  ...
  return t != null && t.list && t.list.length > 0 && (t.from = _codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.Pos(t.from.line, t.from.ch), t.to = _codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.Pos(t.to.line, t.to.ch), _codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.signal(o, "hasCompletion", o, t, e)), t;
});
