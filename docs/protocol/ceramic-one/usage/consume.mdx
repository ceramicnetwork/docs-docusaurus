...
Let's explore how use Ceramic to read messages from a stream. Ceramic nodes in the network subscribe
to data by expressing an [interest](/docs/protocol/ceramic-one/concepts#interests) in a given data
