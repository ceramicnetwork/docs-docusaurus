...
Once you have the extension running locally and visible in your browser, you'll be able to sign in using your browser wallet. Be sure to use the same address and network you used when authenticating yourself on this page.
