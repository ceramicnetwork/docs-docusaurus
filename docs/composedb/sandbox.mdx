...
Welcome to the Sandbox! Before we dive in, let's get you familiar with the GraphiQL interface. Start by pressing the pink play ▶️ icon in the component below:
...
```
 ...
 The query you performed essentially translates to *"give me the first 10 indexed instances of `Posts` and show me the id, body, tag, created, author id from that model."*
