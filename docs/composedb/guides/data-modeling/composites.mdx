...
- If you want to manage your composites from JavaScript, you will need to install the [`@composedb/devtools`](https://composedb.js.org/docs/0.5.x/api/modules/devtools) library
